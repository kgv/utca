                ...
                body.rows(height, total_rows + 1, |mut row| {
                    ...
                    if index < total_rows {
                        ...
                        if self.settings.editable {
                            row.col(|ui| {
                                ui.columns(2, |ui| {
                                    if ui[0].button(RichText::new(ARROW_FAT_LINE_UP)).clicked() {
                                        event = Some(Event::Move {
                                            row: index,
                                            offset: -1,
                                        });
                                    }
                                    if ui[1].button(RichText::new(ARROW_FAT_LINE_DOWN)).clicked() {
                                        event = Some(Event::Move {
                                            row: index,
                                            offset: 1,
                                        });
                        ...
                        row.col(|ui| {
                            ...
                            let fatty_acid = fatty_acid!(carbon);
                            // FattyAcid::new(carbon, Some(vec![9, 12]), None);
                            ...
                            ui.menu_button(title, |ui| {
                                ...
                                ui.horizontal(|ui| {
                                    ...
                                    if !values.is_empty()
                                        && ui.button(RichText::new(MINUS)).clicked()
                                    {
                                    }
                        ...
                        if self.settings.editable {
                            row.col(|ui| {
                                ui.menu_button(RichText::new(PLUS), |ui| {
